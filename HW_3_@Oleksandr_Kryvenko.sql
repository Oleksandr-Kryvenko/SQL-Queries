...
full join employee_salary
	on (employee_salary.salary_id = salary.id)
		where employee_salary.salary_id is null 
		and employee_salary.salary_id < 2000;	
...
select count(employees.employee_name) as qa_qty 
	from employees
full join roles_employee
	on roles_employee.employee_id = employees.id
left join roles
...
select count(employees.employee_name) as middel_qty
	from employees
full join roles_employee
	on roles_employee.employee_id = employees.id
left join roles
...
select count(employees.employee_name) as developers_qty
	from employees
full join roles_employee
	on roles_employee.employee_id = employees.id
left join roles
